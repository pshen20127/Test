...
#include "ComputeMultipleCrystalPlasticityStressAddStateVars.h"
...
registerMooseObject("TensorMechanicsApp", ComputeMultipleCrystalPlasticityStressAddStateVars);

InputParameters
ComputeMultipleCrystalPlasticityStressAddStateVars::validParams()
{
  ...
  params.addClassDescription(
      ...
      "that are inherited from CrystalPlasticityStressUpdateBaseAddStateVars");
...
ComputeMultipleCrystalPlasticityStressAddStateVars::ComputeMultipleCrystalPlasticityStressAddStateVars(
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::initQpStatefulProperties()
{
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::initialSetup()
{
  ...
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    CrystalPlasticityStressUpdateBaseAddStateVars * model =
        dynamic_cast<CrystalPlasticityStressUpdateBaseAddStateVars *>(&getMaterialByName(model_names[i]));
    ...
    if (model)
    {
      ...
      mooseError("Model " + model_names[i] +
                 " is not compatible with ComputeMultipleCrystalPlasticityStressAddStateVars");
  }
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::computeQpStress()
{
  for (unsigned int i = 0; i < _num_models; ++i)
    _models[i]->setQp(_qp);
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::updateStress(RankTwoTensor & cauchy_stress,
                                                     RankFourTensor & jacobian_mult)
{
  ...
  do
  {
    ...
    if (substep_iter > _max_substep_iter && _convergence_failed)
      mooseException("ComputeMultipleCrystalPlasticityStressAddStateVars: Constitutive failure");
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::preSolveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::solveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::postSolveQp(RankTwoTensor & cauchy_stress,
                                                    RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::solveStateVariables()
{
  ...
  do
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityStressAddStateVars: State variables (or the system "
  ...
  if (iteration == _maxiterg)
  {
    if (_print_convergence_message)
      mooseWarning(
          "ComputeMultipleCrystalPlasticityStressAddStateVars: Hardness Integration error. Reached the "
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::solveStress()
{
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityStressAddStateVars: the slip increment exceeds tolerance "
                   "at element ",
                   _current_elem->id(),
                   " and Gauss point ",
                   _qp);
  ...
  while (rnorm > _rtol * rnorm0 && rnorm > _abs_tol && iteration < _maxiter)
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityStressAddStateVars: Failed with line search");
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityStressAddStateVars: Stress Integration error rmax = ",
                   rnorm,
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::calculateResidualAndJacobian()
{
  calculateResidual();
  if (_convergence_failed)
    return;
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::calculateResidual()
{
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::calculateJacobian()
{
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::calcTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::elastoPlasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::elasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
bool
ComputeMultipleCrystalPlasticityStressAddStateVars::lineSearchUpdate(const Real & rnorm_prev,
...
void
ComputeMultipleCrystalPlasticityStressAddStateVars::calculateEigenstrainDeformationGrad()
{
  _inverse_eigenstrain_deformation_grad.zero();
  _inverse_eigenstrain_deformation_grad.addIa(1.0);
