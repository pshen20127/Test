...
class CrystalPlasticityKalidindiUpdateAddStateVars;

/**
 * CrystalPlasticityKalidindiUpdateAddStateVars uses the multiplicative decomposition of the
...
class CrystalPlasticityKalidindiUpdateAddStateVars : public CrystalPlasticityStressUpdateBaseAddStateVars
{
public:
  static InputParameters validParams();

  CrystalPlasticityKalidindiUpdateAddStateVars(const InputParameters & parameters);
