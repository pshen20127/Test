...
/**
 * ComputeMultipleCrystalPlasticityStressAddStateVars (used together with CrystalPlasticityStressUpdateBaseAddStateVars)
 ...
 */
class ComputeMultipleCrystalPlasticityStressAddStateVars : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultipleCrystalPlasticityStressAddStateVars(const InputParameters & parameters);
...
protected:
  ...
  std::vector<CrystalPlasticityStressUpdateBaseAddStateVars *> _models;
